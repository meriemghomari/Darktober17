...
public class EditorScriptAlphaMeshColliderTK2DWindow : EditorWindow {
	...
	//-------------------------------------------------------------------------
	[MenuItem ("Component/2D ColliderGen/2D Toolkit Specific/Show ColliderGen TK2D Window", true)]
	...
	//-------------------------------------------------------------------------
	[MenuItem ("Component/2D ColliderGen/2D Toolkit Specific/Show ColliderGen TK2D Window", false, 1025)]
