...
#if !(UNITY_5_AND_LATER) // Note: in Unity 5 we use workaroud Components since Component menu entries only show up after an editor-restart. See e.g. ComponentMenuAlphaMeshColliderBoneAnimation.
	//-------------------------------------------------------------------------
